...
- Your index will be removed from the dashboard.
- All data associated with the index will be permanently deleted.
- You will not be able to recover the index or its data.
</Aside>
...
Once you're in edit mode, you can click on "**Delete**" on the left side of the main panel.
